...
struct Shoot : public msg::Message {
  Shoot(msg::ObjectId sender, msg::ObjectId destination, Vector2D pos,
        Vector2D dir, int type)
      : Message(msg::FIGHTER_SHOOT, sender, destination), pos_(pos), dir_(dir),
        type_(type) {}
...
struct FighterAsteroidCollisionMsg : public msg::Message {
  FighterAsteroidCollisionMsg(msg::ObjectId sender, msg::ObjectId destination,
...
struct BlackholeFighterCollisionMsg : public msg::Message {
  BlackholeFighterCollisionMsg(msg::ObjectId sender, msg::ObjectId destination,
                               GameObject *fighter, BlackHole *blackhole)
      : Message(msg::BLACKHOLE_FIGHTER_COLLISION, sender, destination),
        blackhole_(blackhole), fighter_(fighter) {}
...
struct BlackholeAsteroidCollisionMsg : public msg::Message {
  BlackholeAsteroidCollisionMsg(msg::ObjectId sender, msg::ObjectId destination,
                                Asteroid *asteroid, BlackHole *blackhole)
      : Message(msg::BLACKHOLE_ASTEROID_COLLISION, sender, destination),
        blackhole_(blackhole), asteroid_(asteroid) {}
...
struct BlackholeBulletCollisionMsg : public msg::Message {
  BlackholeBulletCollisionMsg(msg::ObjectId sender, msg::ObjectId destination,
                              Bullet *bullet, BlackHole *blackhole)
      : Message(msg::BLACKHOLE_BULLET_COLLISION, sender, destination),
        blackhole_(blackhole), bullet_(bullet) {}
...
struct BlackholesInfo : public msg::Message {
	BlackholesInfo(msg::ObjectId sender, msg::ObjectId destination,
		const std::vector<BlackHole *> *blackholes)
		: Message(msg::BLACKHOLES_INFO, sender, destination),
		blackholes_(blackholes) {}
